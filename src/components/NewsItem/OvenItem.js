...
export default class OvenItem extends React.Component {
  ...
  handleSavedArticle = (author,content,description,downvote_count,id,title,upvote_count,url,url_to_image,user_id)=>{
   ArticlesApiService.postSavedArticle(author,content,description,title,url,url_to_image,user_id)
          ...
          <div className='score'>
            ...
            {/* <p>{upvote_count}</p> */}
             <button className='NewsItemBtn'> <img src='https://image.flaticon.com/icons/svg/2224/2224092.svg' alt='not-fresh' className='not-fresh' /> </button> 
              <button className='NewsItemBtn'> <img src='https://image.flaticon.com/icons/svg/148/148838.svg' alt='heart' className='like' onClick={()=>this.handleSavedArticle(author,content,description,title,url,url_to_image)} /></button> 
            <Link to='/comments'>
