...
export default class Header extends Component {
  ...
  renderLogoutLink() {
    ...
    return (
      <div>
        ...
        <div className="menu">
          <Link className="headerLinks" to="/home" onClick={this.hideElements}>
            Home
          </Link>
          <Link
          ...
          <Link className="headerLinks" onClick={this.handleLogoutClick} to="/">
            Logout
          </Link>
        </div>
      </div>
  ...
  renderLoginLink() {
    return (
      <div className="menu">
        <Link className="headerLinks" to="/register">
          Register
        </Link>
        <span></span>
